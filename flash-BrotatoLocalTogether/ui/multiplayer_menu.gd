...
func _build_network_controls() -> void:
	var controls_row : HBoxContainer = $"HBoxContainer/ChatContainer2/VBoxContainer/HBoxContainer"
	...
	controls_row.add_child(host_port_input)
	...
	advertise_ip_input.rect_min_size = Vector2(250, 0)
	...
	controls_row.add_child(advertise_ip_input)
	...
	controls_row.add_child(join_endpoint_input)
	...
	controls_row.add_child(join_endpoint_button)
