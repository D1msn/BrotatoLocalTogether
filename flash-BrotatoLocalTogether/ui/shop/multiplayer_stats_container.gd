...
const shop_options_resource = preload("res://mods-unpacked/flash-BrotatoLocalTogether/opponents_shop/data/opponents_shop_options.tres")
const shop_monster_container_scene = preload("res://mods-unpacked/flash-BrotatoLocalTogether/ui/shop/shop_monster_container.tscn")
