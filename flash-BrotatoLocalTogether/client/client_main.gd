...
var health_tracker
const HealthTracker = preload("res://mods-unpacked/flash-BrotatoLocalTogether/ui/health_tracker/health_tracker.tscn")
...
func _on_EndWaveTimer_timeout() -> void:
	...
	var _error = get_tree().change_scene("res://mods-unpacked/flash-BrotatoLocalTogether/ui/shop/multiplayer_shop.tscn")
